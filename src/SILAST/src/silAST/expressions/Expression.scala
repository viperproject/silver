  ...
  extends Expression
{
  ...
  protected[expressions] val pSubExpressions :Seq[PExpression]
}
  ...
  with PExpression
{
  ...
  protected[expressions] val pTerm1 : PTerm
  protected[expressions] val pTerm2 : PTerm
}
...
sealed trait PUnaryExpression extends UnaryExpression with PExpression
{
  ...
  protected[expressions] val pOperand1 : PExpression
}
...
sealed trait PBinaryExpression extends BinaryExpression with PExpression{
  ...
  protected[expressions] val pOperand1 : PExpression
  protected[expressions] val pOperand2 : PExpression
}
  ...
  extends Expression with DExpression with PExpression
{
  ...
  protected[expressions] val gSubExpressions: Seq[GExpression]
}
