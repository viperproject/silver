...
final class Halt()(val sourceLocation : SourceLocation) extends ControlStatement
{
  ...
  override def equals(other : Any) = other match {case h : Halt => true case _ => false}
  ...
  extends ControlStatement
{
  ...
  override def equals(other : Any) = other match { case b : Branch => b eq this case _ => false }
  override val hashCode = toString.hashCode()
  ...
  extends ControlStatement
{
  ...
  override def equals(other : Any) = other match { case g : Goto => g eq this case _ => false }
  override val hashCode = toString.hashCode()
