...
class FeatureCombinationsTests extends FunSuite with Matchers {
  ...
  test("Function with magic wand") {
    ...
    val f2 = Function("ofo", Seq(LocalVarDecl("y", Int)()), Bool, Seq(), Seq(), Seq(wand), Option(TrueLit()()))()
  ...
  test("Function with perm expression") {
    ...
    val f2 = Function("ofo", Seq(LocalVarDecl("y", Int)()), Bool, Seq(), Seq(), Seq(perm), Option(TrueLit()()))()
  ...
  test("Function with forperm") {
    ...
    val f2 = Function("ofo", Seq(LocalVarDecl("y", Int)()), Bool, Seq(), Seq(), Seq(q), Option(TrueLit()()))()
