...
class MethodDependencyTests extends FunSuite with Matchers {
  ...
  val m0: Method = Method("m0", Seq(LocalVarDecl("x", Ref)()), Seq(), Seq(PredicateAccessPredicate(PredicateAccess(Seq(LocalVar("x")(Ref)), p4)(), FullPerm()())()), Seq(), Seqn(Seq(MethodCall(m1,Seq(),Seq())()), Seq())())()
  val test: Method = Method("test",
    Seq(LocalVarDecl("x", Ref)()),
    Seq(),
    // preconditions:
    Seq(And(FieldAccessPredicate(FieldAccess(LocalVar("x")(Ref), f0)(), FullPerm()())(), And(FuncApp(fun0, Seq())(), PredicateAccessPredicate(PredicateAccess(Seq(), p0)(), FullPerm()())())())()),
    // postconditions:
    Seq(And(FieldAccessPredicate(FieldAccess(LocalVar("x")(Ref), f1)(), FullPerm()())(), And(FuncApp(fun1, Seq())(), PredicateAccessPredicate(PredicateAccess(Seq(), p1)(), FullPerm()())())())()),
    // body of the method:
    Seqn(Seq(
      Unfold(PredicateAccessPredicate(PredicateAccess(Seq(), p2)(), FullPerm()())())(),
