...
import semper.sil.ast.expressions.{PPredicatePermissionExpression, PredicatePermissionExpression, PProgramVariableSubstitution, ProgramVariableSubstitution}
...
final class PFieldLocation private [sil](override val receiver: PTerm,field : Field)
...
final class PPredicateLocation private [sil](override val receiver: PTerm,predicate : Predicate)
  ...
  with PTerm
{
  ...
  protected[sil] def pCondition: PTerm

  protected[sil] def ppTerm: PTerm

  protected[sil] def pnTerm: PTerm
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
private [sil] final class PIfThenElseTermC
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
final class PFunctionApplicationTerm private [sil]
...
private [sil] final class PDomainFunctionApplicationTermC
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
final class PCastTerm private [sil]
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
final class PFieldReadTerm private [sil]
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
final class PUnfoldingTerm private [sil]
  ...
  with DTerm
{
  ...
  protected[sil] def dCondition: DTerm

  protected[sil] def dpTerm: DTerm

  protected[sil] def dnTerm: DTerm
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
private [sil] final class DIfThenElseTermC
...
private [sil] final class DDomainFunctionApplicationTermC
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
final class GIfThenElseTerm private [sil]
