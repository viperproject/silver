...
case class PWhile(cond: PExp, invs: Seq[PExp], body: PStmt) extends PStmt with PScope
case class PFresh(vars: Seq[PIdnUse]) extends PStmt
case class PConstraining(vars: Seq[PIdnUse], stmt: PStmt) extends PStmt with PScope
