...
/**
 * The `LoopSpecsPluginRec` extends Viper Silver with additional syntax and parsing logic
...
class LoopSpecsPluginRec(
   ...
   * additional statements/instructions: recursive version.
