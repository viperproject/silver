...
import semper.sil.ast.expressions.util.{DTermSequence, GTermSequence}
import semper.sil.ast.types.{booleanType, DataTypeFactory, DataType}
import collection.{mutable, immutable}
import semper.sil.ast.programs.symbols.ProgramVariable
import semper.sil.ast.domains._
import semper.sil.ast.expressions.{DProgramVariableSubstitutionC, DProgramVariableSubstitution}
...
trait DTermFactory extends NodeFactory with GTermFactory with DataTypeFactory {
  ...
  /////////////////////////////////////////////////////////////////////////
  protected[sil] def migrate(t: DTerm) {
    if (terms contains t)
      return
    t match {
