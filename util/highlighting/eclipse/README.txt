...
5. Create a new project. Create a new file in the project and give it a name with the file extension ".vpr". If Eclipse asks you if you want to add the Xtext nature to the project, answer yes.
